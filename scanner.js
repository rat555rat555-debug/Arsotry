...
async function startAR() {
  try {
    ...
    if (!config.targetFile || !config.videoFile) {
      throw new Error("config.js ยังไม่ได้ตั้ง targetFile หรือ videoFile");
    }

    await checkFile(config.targetFile, "ไฟล์ poster.mind");
